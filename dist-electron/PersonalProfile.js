"use strict";
/**
 * Personal Profile for Sahil Kulkarni
 * Updated according to latest resume
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.PersonalProfileHelper = exports.personalProfile = void 0;
exports.personalProfile = {
    name: "Sahil Kulkarni",
    ...
    experience: {
        totalYears: 1, // Based on project and internship experience
    },
    education: [
        {
...
class PersonalProfileHelper {
    static getIntroduction() {
        const profile = exports.personalProfile;
    ...
    static getRelevantExperience(topic) {
        ...
        profile.projects.forEach(project => {
            // Check if topic matches project technologies
            const techMatch = project.technologies.some(tech => tech.toLowerCase().includes(topicLower));
            // Check if topic matches project name (split into words)
            const projectWords = project.name.toLowerCase().replace(/[^\w\s]/g, ' ').split(' ').filter(word => word.length > 2);
            const nameMatch = projectWords.some(word => topicLower.includes(word) || word.includes(topicLower));
            // Check if topic matches project description
            const descMatch = project.description.toLowerCase().includes(topicLower);
            if (techMatch || nameMatch || descMatch) {
...
exports.PersonalProfileHelper = PersonalProfileHelper;
