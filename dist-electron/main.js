...
async function initializeApp() {
    ...
    process.on('warning', (warning) => {
        // Suppress the textured window deprecation warning as it's a false positive for our use case
        if (warning.message.includes('textured') || warning.message.includes('AVCaptureDeviceTypeExternal')) {
    ...
    // Suppress media device warnings in development
    if (process.env.NODE_ENV === "development") {
        ...
        // Suppress the AVCaptureDeviceTypeExternal deprecation warning
