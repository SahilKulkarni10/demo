...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    ...
    analyzeTextInput: (text, language) => electron_1.ipcRenderer.invoke("analyze-text-input", text, language),
    solveCodingProblem: (problemDescription, language) => electron_1.ipcRenderer.invoke("solve-coding-problem", problemDescription, language),
    optimizeCode: (code, language, requirements) => electron_1.ipcRenderer.invoke("optimize-code", code, language, requirements),
    debugCode: (code, language, errorDescription) => electron_1.ipcRenderer.invoke("debug-code", code, language, errorDescription),
    formatCode: (code, language) => electron_1.ipcRenderer.invoke("format-code", code, language),
    answerQuestion: (question) => electron_1.ipcRenderer.invoke("answer-question", question),
    answerInterviewQuestion: (question) => electron_1.ipcRenderer.invoke("answer-interview-question", question),
