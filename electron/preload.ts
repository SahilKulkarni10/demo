...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  analyzeTextInput: (text: string, language?: string) => ipcRenderer.invoke("analyze-text-input", text, language),
  solveCodingProblem: (problemDescription: string, language?: string) => ipcRenderer.invoke("solve-coding-problem", problemDescription, language),
  optimizeCode: (code: string, language?: string, requirements?: string) => ipcRenderer.invoke("optimize-code", code, language, requirements),
  debugCode: (code: string, language?: string, errorDescription?: string) => ipcRenderer.invoke("debug-code", code, language, errorDescription),
  formatCode: (code: string, language?: string) => ipcRenderer.invoke("format-code", code, language),
  answerQuestion: (question: string) => ipcRenderer.invoke("answer-question", question),
  answerInterviewQuestion: (question: string) => ipcRenderer.invoke("answer-interview-question", question),
