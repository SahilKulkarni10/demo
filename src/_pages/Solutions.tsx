...
import PersonalProfileDisplay from "../components/PersonalProfileDisplay"
import {
  Toast,
  ToastDescription,
  ToastMessage,
...
export const ContentSection = ({
  ...
  <div className="space-y-2">
    ...
    {isLoading ? (
      ...
      <div className="text-[13px] leading-[1.4] text-gray-100 max-w-[600px] p-3 bg-gray-900/50 rounded-lg border border-gray-700/50">
        {content}
      </div>
    )}
  </div>
...
const Solutions: React.FC<SolutionsProps> = ({ setView }) => {
  ...
  const handleExtractText = async (screenshot: { path: string; preview: string }) => {
    const screenshotIndex = extraScreenshots.findIndex(s => s.path === screenshot.path)
    ...
    <>
      {!isResetting && queryClient.getQueryData(["new_solution"]) ? (
        ...
        <div ref={contentRef} className="relative space-y-3 px-4 py-3">
          ...
          {/* Personal Profile Display - Shows when interview questions are detected */}
          {(audioResult?.answer || customContent) && (
            <PersonalProfileDisplay variant="interview-ready" />
          )}
            ...
            <div className="bg-transparent w-fit">
              <div className="pb-3">
                <div className="space-y-3 w-fit">
                  ...
                  {/* Extracted Text Display for Solutions page */}
          ...
          <div className="w-full text-sm text-black bg-transparent backdrop-blur-md rounded-md border border-white/10 shadow-lg">
